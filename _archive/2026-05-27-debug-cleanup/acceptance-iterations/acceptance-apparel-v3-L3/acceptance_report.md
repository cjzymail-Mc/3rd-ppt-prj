...
- chart_series_differs_from_template: series 与模板相同（写入未生效） | tpl=[[5.0, 15.0], [20.0, 17.0], [10.0, 3.0]] actual=[[5.0, 15.0], [20.0, 17.0], [10.0, 3.0]]
- 详情：`{"actual": [[5.0, 15.0], [20.0, 17.0], [10.0, 3.0]], "template": [[5.0, 15.0], [20.0, 17.0], [10.0, 3.0]], "same": true}`

### [L1] p13_temp_mode_label [p13] TextBox 50
- text contains '5℃~15℃': False (actual snippet='适宜温度\r5~15℃')
...
### [L3] p13_textbox6_runs::TextBox 6 [p13] TextBox 6
- runs structure (dims=['rgb', 'bold', 'size']): new=1 runs vs template=2 runs
- 详情：`{"dims": ["rgb", "bold", "size"], "new_seq": [[0, -1, 20.0]], "template_seq": [[0, -1, 20.0], [255, -1, 16.0]]}`

### [L3] p13_textbox6_runs::TextBox 6 [p14] TextBox 6
- shape 'TextBox 6' 在 new 侧找不到对应（L0 配对失败）

### [L3] p13_textbox14_runs::TextBox 14 [p13] TextBox 14
- runs structure (dims=['rgb', 'bold', 'size']): new=1 runs vs template=2 runs
- 详情：`{"dims": ["rgb", "bold", "size"], "new_seq": [[0, -1, 20.0]], "template_seq": [[0, -1, 20.0], [255, -1, 14.0]]}`

### [L3] p13_textbox14_runs::TextBox 14 [p14] TextBox 14
- shape 'TextBox 14' 在 new 侧找不到对应（L0 配对失败）

### [L3] p13_textbox17_runs::TextBox 17 [p13] TextBox 17
- runs structure (dims=['rgb', 'bold', 'size']): new=1 runs vs template=2 runs
- 详情：`{"dims": ["rgb", "bold", "size"], "new_seq": [[0, -1, 20.0]], "template_seq": [[0, -1, 20.0], [255, -1, 16.0]]}`

### [L3] p13_textbox17_runs::TextBox 17 [p14] TextBox 17
- shape 'TextBox 17' 在 new 侧找不到对应（L0 配对失败）

### [L3] p13_textbox20_runs::TextBox 20 [p13] TextBox 20
- runs structure (dims=['rgb', 'bold', 'size']): new=1 runs vs template=2 runs
- 详情：`{"dims": ["rgb", "bold", "size"], "new_seq": [[0, -1, 20.0]], "template_seq": [[0, -1, 20.0], [255, -1, 16.0]]}`

### [L3] p13_textbox20_runs::TextBox 20 [p14] TextBox 20
- shape 'TextBox 20' 在 new 侧找不到对应（L0 配对失败）

### [L3] p13_textbox50_runs::TextBox 50 [p13] TextBox 50
- runs structure (dims=['rgb', 'bold', 'size']): new=1 runs vs template=2 runs
- 详情：`{"dims": ["rgb", "bold", "size"], "new_seq": [[0, -1, 20.0]], "template_seq": [[0, -1, 20.0], [255, -1, 16.0]]}`

### [L3] p13_textbox50_runs::TextBox 50 [p14] TextBox 50
- shape 'TextBox 50' 在 new 侧找不到对应（L0 配对失败）

### [L3] p14_textbox23_runs::TextBox 23 [p13] TextBox 23
- shape 'TextBox 23' 在 new 侧找不到对应（L0 配对失败）

### [L3] p14_textbox23_runs::TextBox 23 [p14] TextBox 23
- runs structure (dims=['rgb', 'bold', 'size']): new=13 runs vs template=12 runs
- 详情：`{"dims": ["rgb", "bold", "size"], "new_seq": [[0, -1, 14.0], [255, -1, 14.0], [0, -1, 14.0], [255, -1, 14.0], [0, -1, 14.0], [255, -1, 14.0], [0, -1, 14.0], [255, -1, 14.0], [0, -1, 14.0], [255, -1, 14.0], [0, -1, 14.0], [255, -1, 14.0], [0, -1, 14.0]], "template_seq": [[192, -1, 14.0], [0, 0, 14.0], [255, -1, 14.0], [0, 0, 14.0], [255, -1, 14.0], [0, 0, 14.0], [255, -1, 14.0], [0, 0, 14.0], [255, -1, 14.0], [0, 0, 14.0], [255, -1, 14.0], [0, 0, 14.0]]}`

### [L3] p14_textbox26_runs::TextBox 26 [p13] TextBox 26
- shape 'TextBox 26' 在 new 侧找不到对应（L0 配对失败）

### [L3] p14_textbox26_runs::TextBox 26 [p14] TextBox 26
- runs structure (dims=['rgb', 'bold', 'size']): new=19 runs vs template=23 runs
- 详情：`{"dims": ["rgb", "bold", "size"], "new_seq": [[0, -1, 14.0], [15773696, -1, 14.0], [0, -1, 14.0], [15773696, -1, 14.0], [0, -1, 14.0], [15773696, -1, 14.0], [0, -1, 14.0], [15773696, -1, 14.0], [0, -1, 14.0], [15773696, -1, 14.0], [0, -1, 14.0], [15773696, -1, 14.0], [0, -1, 14.0], [15773696, -1, 14.0], [0, -1, 14.0], [15773696, -1, 14.0], [0, -1, 14.0], [15773696, -1, 14.0], [0, -1, 14.0]], "template_seq": [[12611584, -1, 14.0], [0, 0, 14.0], [15773696, -1, 14.0], [0, 0, 14.0], [15773696, -1, 14.0], [0, 0, 14.0], [15773696, -1, 14.0], [0, 0, 14.0], [15773696, -1, 14.0], [0, 0, 14.0], [15773696, -1, 14.0], [0, 0, 14.0], [15773696, -1, 14.0], [0, 0, 14.0], [15773696, -1, 14.0], [0, 0, 14.0], [0, -1, 14.0], [0, 0, 14.0], [15773696, -1, 14.0], [0, 0, 14.0], [0, 0, 16.0], [0, -1, 16.0], [0, 0, 16.0]]}`

### [L5] L5_ssim_p14 [p14]
- SSIM=0.6163 (threshold=0.85)
- 详情：`{"ssim": 0.6163318699314722, "threshold": 0.85, "png_new": "D:\\Technique Support\\Claude Code Learning\\3rd-ppt-prj\\debug\\acceptance-apparel-v3-L3\\visual\\new_013.png", "png_template": "D:\\Technique Support\\Claude Code Learning\\3rd-ppt-prj\\debug\\acceptance-apparel-v3-L3\\visual\\template_014.png"}`
...
### L1 数据
- ✗ [must_fix] p13_chart63_temp_range [p13] — chart_series_differs_from_template: series 与模板相同（写入未生效） | tpl=[[5.0, 15.0], [20.0, 17.0], [10.0, 3.0]] actual=[[5.0, 15.0], [20.0, 17.0], [10.0, 3.0]]
- ✗ [must_fix] p13_temp_mode_label [p13] — text contains '5℃~15℃': False (actual snippet='适宜温度\r5~15℃')
...
### L3 染色
- ✗ [must_fix] p13_textbox6_runs::TextBox 6 [p13] — runs structure (dims=['rgb', 'bold', 'size']): new=1 runs vs template=2 runs
- ✗ [must_fix] p13_textbox6_runs::TextBox 6 [p14] — shape 'TextBox 6' 在 new 侧找不到对应（L0 配对失败）
- ✗ [must_fix] p13_textbox14_runs::TextBox 14 [p13] — runs structure (dims=['rgb', 'bold', 'size']): new=1 runs vs template=2 runs
- ✗ [must_fix] p13_textbox14_runs::TextBox 14 [p14] — shape 'TextBox 14' 在 new 侧找不到对应（L0 配对失败）
- ✗ [must_fix] p13_textbox17_runs::TextBox 17 [p13] — runs structure (dims=['rgb', 'bold', 'size']): new=1 runs vs template=2 runs
- ✗ [must_fix] p13_textbox17_runs::TextBox 17 [p14] — shape 'TextBox 17' 在 new 侧找不到对应（L0 配对失败）
- ✗ [must_fix] p13_textbox20_runs::TextBox 20 [p13] — runs structure (dims=['rgb', 'bold', 'size']): new=1 runs vs template=2 runs
- ✗ [must_fix] p13_textbox20_runs::TextBox 20 [p14] — shape 'TextBox 20' 在 new 侧找不到对应（L0 配对失败）
- ✗ [must_fix] p13_textbox50_runs::TextBox 50 [p13] — runs structure (dims=['rgb', 'bold', 'size']): new=1 runs vs template=2 runs
- ✗ [must_fix] p13_textbox50_runs::TextBox 50 [p14] — shape 'TextBox 50' 在 new 侧找不到对应（L0 配对失败）
- ✗ [must_fix] p14_textbox23_runs::TextBox 23 [p13] — shape 'TextBox 23' 在 new 侧找不到对应（L0 配对失败）
- ✗ [must_fix] p14_textbox23_runs::TextBox 23 [p14] — runs structure (dims=['rgb', 'bold', 'size']): new=13 runs vs template=12 runs
- ✗ [must_fix] p14_textbox26_runs::TextBox 26 [p13] — shape 'TextBox 26' 在 new 侧找不到对应（L0 配对失败）
- ✗ [must_fix] p14_textbox26_runs::TextBox 26 [p14] — runs structure (dims=['rgb', 'bold', 'size']): new=19 runs vs template=23 runs
...
### L5 视觉
- ✓ [must_fix] L5_ssim_p13 [p13] — SSIM=0.9590 (threshold=0.85)
- ✗ [must_fix] L5_ssim_p14 [p14] — SSIM=0.6163 (threshold=0.85)
