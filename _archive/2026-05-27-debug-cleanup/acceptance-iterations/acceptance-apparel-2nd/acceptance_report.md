...
- chart series (excel DSL 执行失败: (-2147417848, '被调用的对象已与其客户端断开连接。', None, None)): expected 为 None
- 详情：`{"actual": [[5.0, 15.0], [20.0, 17.0], [10.0, 3.0]], "expected": null, "expected_from": "excel DSL 执行失败: (-2147417848, '被调用的对象已与其客户端断开连接。', None, None)"}`
...
### L1 数据
- ✗ [must_fix] p13_chart63_temp_range [p13] — chart series (excel DSL 执行失败: (-2147417848, '被调用的对象已与其客户端断开连接。', None, None)): expected 为 None
