...
### [L3] p13_rr53_two_run_signature::Rounded Rectangle 53 [p13] Rounded Rectangle 53
- runs signature (dims=['rgb', 'bold', 'size'], ignore_ws=True): new=2 runs vs expected=2 runs
- 详情：`{"dims": ["rgb", "bold", "size"], "new_seq": [[0, -1, 20.0], [255, -1, 16.0]], "expected_seq": [[16777215, -1, 11.0], [16777215, -1, 24.0]], "new_runs_text": ["累计跑量km\r", "465"]}`

### [L3] p13_rr55_two_run_signature::Rounded Rectangle 55 [p13] Rounded Rectangle 55
- runs signature (dims=['rgb', 'bold', 'size'], ignore_ws=True): new=1 runs vs expected=2 runs
- 详情：`{"dims": ["rgb", "bold", "size"], "new_seq": [[0, -1, 20.0]], "expected_seq": [[16777215, -1, 11.0], [16777215, -1, 24.0]], "new_runs_text": ["定位日常训练4/4"]}`
...
- ✗ [must_fix] p13_rr55_two_run_signature::Rounded Rectangle 55 [p13] — runs signature (dims=['rgb', 'bold', 'size'], ignore_ws=True): new=1 runs vs expected=2 runs
