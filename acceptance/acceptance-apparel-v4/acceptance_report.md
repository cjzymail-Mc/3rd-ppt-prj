...
- runs structure (dims=['rgb', 'bold', 'size']): new=2 runs vs template=2 runs
- 详情：`{"dims": ["rgb", "bold", "size"], "new_seq": [[0, 0, 20.0], [255, 0, 16.0]], "template_seq": [[0, -1, 20.0], [255, -1, 16.0]]}`

### [L3] p13_textbox14_runs::TextBox 14 [p13] TextBox 14
- runs structure (dims=['rgb', 'bold', 'size']): new=2 runs vs template=2 runs
- 详情：`{"dims": ["rgb", "bold", "size"], "new_seq": [[0, 0, 20.0], [255, 0, 16.0]], "template_seq": [[0, -1, 20.0], [255, -1, 14.0]]}`
...
- runs structure (dims=['rgb', 'bold', 'size']): new=12 runs vs template=12 runs
- 详情：`{"dims": ["rgb", "bold", "size"], "new_seq": [[192, 0, 14.0], [0, 0, 14.0], [255, -1, 14.0], [0, 0, 14.0], [255, -1, 14.0], [0, 0, 14.0], [255, -1, 14.0], [0, 0, 14.0], [255, -1, 14.0], [0, 0, 14.0], [255, -1, 14.0], [0, 0, 14.0]], "template_seq": [[192, -1, 14.0], [0, 0, 14.0], [255, -1, 14.0], [0, 0, 14.0], [255, -1, 14.0], [0, 0, 14.0], [255, -1, 14.0], [0, 0, 14.0], [255, -1, 14.0], [0, 0, 14.0], [255, -1, 14.0], [0, 0, 14.0]]}`

### [L3] p14_textbox26_runs::TextBox 26 [p14] TextBox 26
- runs structure (dims=['rgb', 'bold', 'size']): new=24 runs vs template=23 runs
- 详情：`{"dims": ["rgb", "bold", "size"], "new_seq": [[12611584, 0, 14.0], [0, 0, 14.0], [15773696, -1, 14.0], [0, 0, 14.0], [15773696, -1, 14.0], [0, 0, 14.0], [15773696, -1, 14.0], [0, 0, 14.0], [15773696, -1, 14.0], [0, 0, 14.0], [15773696, -1, 14.0], [0, 0, 14.0], [15773696, -1, 14.0], [0, 0, 14.0], [15773696, -1, 14.0], [0, 0, 14.0], [15773696, -1, 14.0], [0, 0, 14.0], [15773696, -1, 14.0], [0, 0, 14.0], [15773696, -1, 14.0], [0, 0, 14.0], [15773696, -1, 14.0], [0, 0, 14.0]], "template_seq": [[12611584, -1, 14.0], [0, 0, 14.0], [15773696, -1, 14.0], [0, 0, 14.0], [15773696, -1, 14.0], [0, 0, 14.0], [15773696, -1, 14.0], [0, 0, 14.0], [15773696, -1, 14.0], [0, 0, 14.0], [15773696, -1, 14.0], [0, 0, 14.0], [15773696, -1, 14.0], [0, 0, 14.0], [15773696, -1, 14.0], [0, 0, 14.0], [0, -1, 14.0], [0, 0, 14.0], [15773696, -1, 14.0], [0, 0, 14.0], [0, 0, 16.0], [0, -1, 16.0], [0, 0, 16.0]]}`

### [L4] gpt_respondent_info_called
- event gpt_respondent_info count=4 (min=1 max=2)

### [L5] L5_ssim_p14 [p14]
- SSIM=0.7121 (threshold=0.85)
- 详情：`{"ssim": 0.7120631891842306, "threshold": 0.85, "png_new": "D:\\Technique Support\\Claude Code Learning\\3rd-ppt-prj\\debug\\acceptance-apparel-v4\\visual\\new_023.png", "png_template": "D:\\Technique Support\\Claude Code Learning\\3rd-ppt-prj\\debug\\acceptance-apparel-v4\\visual\\template_014.png"}`
...
- ✓ [must_fix] geometry_global::Chart 8 [p13] — geom diff worst=left=0.00 (tol=2.0)
...
### L3 染色
- ✗ [must_fix] p13_textbox6_runs::TextBox 6 [p13] — runs structure (dims=['rgb', 'bold', 'size']): new=2 runs vs template=2 runs
- ✗ [must_fix] p13_textbox14_runs::TextBox 14 [p13] — runs structure (dims=['rgb', 'bold', 'size']): new=2 runs vs template=2 runs
- ✗ [must_fix] p13_textbox17_runs::TextBox 17 [p13] — runs structure (dims=['rgb', 'bold', 'size']): new=2 runs vs template=2 runs
- ✗ [must_fix] p13_textbox20_runs::TextBox 20 [p13] — runs structure (dims=['rgb', 'bold', 'size']): new=2 runs vs template=2 runs
- ✗ [must_fix] p13_textbox50_runs::TextBox 50 [p13] — runs structure (dims=['rgb', 'bold', 'size']): new=2 runs vs template=2 runs
- ✗ [must_fix] p14_textbox23_runs::TextBox 23 [p14] — runs structure (dims=['rgb', 'bold', 'size']): new=12 runs vs template=12 runs
- ✗ [must_fix] p14_textbox26_runs::TextBox 26 [p14] — runs structure (dims=['rgb', 'bold', 'size']): new=24 runs vs template=23 runs
...
- ✗ [must_fix] gpt_respondent_info_called — event gpt_respondent_info count=4 (min=1 max=2)
- ✓ [must_fix] chart63_write_ok — trace events present: 1/1; missing=[]

### L5 视觉
- ✓ [must_fix] L5_ssim_p13 [p13] — SSIM=0.9700 (threshold=0.85)
- ✗ [must_fix] L5_ssim_p14 [p14] — SSIM=0.7121 (threshold=0.85)
