...
- 详情：`{"dims": ["rgb", "bold", "italic", "size"], "new_seq": [[0, 0, 0, 20.0], [255, -1, 0, 16.0]], "template_seq": [[0, -1, 0, 20.0], [255, -1, 0, 16.0]]}`

### [L3] p13_textbox14_runs::TextBox 14 [p13] TextBox 14
- runs structure (dims=['rgb', 'bold', 'italic', 'size']): new=2 runs vs template=2 runs
- 详情：`{"dims": ["rgb", "bold", "italic", "size"], "new_seq": [[0, 0, 0, 20.0], [255, -1, 0, 16.0]], "template_seq": [[0, -1, 0, 20.0], [255, -1, 0, 14.0]]}`
...
- runs structure (dims=['rgb', 'bold', 'italic', 'size']): new=10 runs vs template=12 runs
- 详情：`{"dims": ["rgb", "bold", "italic", "size"], "new_seq": [[192, -1, 0, 14.0], [0, 0, 0, 14.0], [255, -1, 0, 14.0], [0, 0, 0, 14.0], [255, -1, 0, 14.0], [0, 0, 0, 14.0], [255, -1, 0, 14.0], [0, 0, 0, 14.0], [255, -1, 0, 14.0], [0, 0, 0, 14.0]], "template_seq": [[192, -1, 0, 14.0], [0, 0, 0, 14.0], [255, -1, 0, 14.0], [0, 0, 0, 14.0], [255, -1, 0, 14.0], [0, 0, 0, 14.0], [255, -1, 0, 14.0], [0, 0, 0, 14.0], [255, -1, 0, 14.0], [0, 0, 0, 14.0], [255, -1, 0, 14.0], [0, 0, 0, 14.0]]}`

### [L3] p14_textbox26_runs::TextBox 26 [p14] TextBox 26
- runs structure (dims=['rgb', 'bold', 'italic', 'size']): new=23 runs vs template=23 runs
- 详情：`{"dims": ["rgb", "bold", "italic", "size"], "new_seq": [[12611584, -1, 0, 14.0], [0, 0, 0, 14.0], [15773696, -1, 0, 14.0], [0, 0, 0, 14.0], [15773696, -1, 0, 14.0], [0, 0, 0, 14.0], [15773696, -1, 0, 14.0], [0, 0, 0, 14.0], [15773696, -1, 0, 14.0], [0, 0, 0, 14.0], [15773696, -1, 0, 14.0], [0, 0, 0, 14.0], [15773696, -1, 0, 14.0], [0, 0, 0, 14.0], [0, 0, 0, 16.0], [15773696, -1, 0, 16.0], [0, 0, 0, 16.0], [15773696, -1, 0, 16.0], [0, 0, 0, 16.0], [15773696, -1, 0, 16.0], [0, 0, 0, 16.0], [15773696, -1, 0, 16.0], [0, 0, 0, 16.0]], "template_seq": [[12611584, -1, 0, 14.0], [0, 0, 0, 14.0], [15773696, -1, 0, 14.0], [0, 0, 0, 14.0], [15773696, -1, 0, 14.0], [0, 0, 0, 14.0], [15773696, -1, 0, 14.0], [0, 0, 0, 14.0], [15773696, -1, 0, 14.0], [0, 0, 0, 14.0], [15773696, -1, 0, 14.0], [0, 0, 0, 14.0], [15773696, -1, 0, 14.0], [0, 0, 0, 14.0], [15773696, -1, 0, 14.0], [0, 0, 0, 14.0], [0, -1, 0, 14.0], [0, 0, 0, 14.0], [15773696, -1, 0, 14.0], [0, 0, 0, 14.0], [0, 0, 0, 16.0], [0, -1, 0, 16.0], [0, 0, 0, 16.0]]}`

### [L5] L5_ssim_p14 [p14]
- SSIM=0.7149 (threshold=0.85)
- 详情：`{"ssim": 0.7149293726351443, "threshold": 0.85, "png_new": "D:\\Technique Support\\Claude Code Learning\\3rd-ppt-prj\\acceptance\\acceptance-apparel-fix6\\visual\\new_023.png", "png_template": "D:\\Technique Support\\Claude Code Learning\\3rd-ppt-prj\\acceptance\\acceptance-apparel-fix6\\visual\\template_014.png"}`
...
- ✗ [must_fix] p14_textbox23_runs::TextBox 23 [p14] — runs structure (dims=['rgb', 'bold', 'italic', 'size']): new=10 runs vs template=12 runs
- ✗ [must_fix] p14_textbox26_runs::TextBox 26 [p14] — runs structure (dims=['rgb', 'bold', 'italic', 'size']): new=23 runs vs template=23 runs
...
### L5 视觉
- ✓ [must_fix] L5_ssim_p13 [p13] — SSIM=0.9677 (threshold=0.85)
- ✗ [must_fix] L5_ssim_p14 [p14] — SSIM=0.7149 (threshold=0.85)
