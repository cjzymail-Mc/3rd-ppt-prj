...
| 3B | `03-build_ppt_com.py` | build_shape_content.json + Template | claude-ppt X.Y.pptx, build-ppt-report.md, post_write_readback.json | 文件可打开且写入成功 |
| 4 | `04-shape_diff_test.py` | Template p15 vs claude-ppt p1 | fix-ppt.md, diff_result.json, diff_semantic_report.md | Visual>=98, Read>=95, Sem=100 |
...
- 版本命名：claude-ppt 1.0 -> 1.1 -> 1.2（不覆盖历史文件）
